...
plus a [BEN glossary](../plugins/glossaries.md) of official
definitions.
...
[why we scope plugins narrowly](../dev/design-pattern.md).
...
modes, and the changes we shipped, is written up in the *Field Guide to
