...
That is worth turning into a precondition: **analyze the quality and
documentation of the candidate datasets before the pilot starts**, and
choose data that is already good. The pilot will surface gaps either
way (ours surfaced datasets whose descriptions needed improving, and
the absence of metadata is noticed the moment a question depends on
it), but a pilot should deepen good data, not rescue bad data.
